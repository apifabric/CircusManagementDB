...
resourcename="circusmanagementdb"  # lower case, only
resourcegroup="circusmanagementdb_rg"
...
# git clone https://github.com/apilogicserver/circusmanagementdb.git
# cd circusmanagementdb
...
az group create --name circusmanagementdb_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group circusmanagementdb_rg --sku S1 --is-linux
az container create --resource-group circusmanagementdb_rg --name circusmanagementdb --image apilogicserver/circusmanagementdb:latest --dns-name-label circusmanagementdb --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//circusmanagementdb.westus.azurecontainer.io:5656'

...
const routes: Routes = [
  ...
  { path: ':id', component: EquipmentDetailComponent,
    ...
    path: ':equipment_id/ShowEquipmentAssociation', loadChildren: () => import('../ShowEquipmentAssociation/ShowEquipmentAssociation.module').then(m => m.ShowEquipmentAssociationModule),
    data: {
        oPermission: {

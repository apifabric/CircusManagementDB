...
@Component({
  selector: 'AnimalShowAssociation-home',
  templateUrl: './AnimalShowAssociation-home.component.html',
  styleUrls: ['./AnimalShowAssociation-home.component.scss']
})
export class AnimalShowAssociationHomeComponent implements AfterViewInit {

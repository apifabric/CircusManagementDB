...
@Component({
  selector: 'Performer-home',
  templateUrl: './Performer-home.component.html',
  styleUrls: ['./Performer-home.component.scss']
})
export class PerformerHomeComponent implements AfterViewInit {
